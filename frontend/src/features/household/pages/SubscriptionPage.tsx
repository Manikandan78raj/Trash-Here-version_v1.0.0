    ...
    <div className="space-y-8">
        ...
        <Card className="p-6 rounded-[30px] bg-gradient-to-r from-emerald-900/40 to-black/80 border border-emerald-500/30 backdrop-blur-md text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="space-y-1">
            ...
            <Text variant="muted" className="text-zinc-300">
              Includes {currentSub.pickupsPerMonth} scheduled waste pickups per month & bonus point multipliers.
            </Text>
          </div>
          <Button
            variant="ghost"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        >
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-baseline">
                ...
                <span className="text-3xl font-extrabold">$19<span className="text-sm font-normal text-zinc-500">/mo</span></span>
              </div>
            ...
            <ul className="space-y-3 text-sm border-t border-zinc-200 dark:border-zinc-800 pt-6">
              <li className="flex items-center gap-3">
                ...
                <span><strong>2 Scheduled Pickups</strong> per month</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-[rgb(215,255,67)] font-bold">✓</span>
              ...
              <li className="flex items-center gap-3">
                <span className="text-[rgb(215,255,67)] font-bold">✓</span>
                <span><strong>1.1x Multiplier</strong> on Green Points</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-[rgb(215,255,67)] font-bold">✓</span>
          ...
          >
            {isStarter ? "Current Plan" : subscribeMutation.isPending ? "Enrolling..." : "Select Eco Starter"}
          </Button>
        </Card>
        ...
        >
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-baseline">
                <Heading level={3} className="text-white">Eco Pro</Heading>
                <span className="text-3xl font-extrabold text-[rgb(215,255,67)]">$49<span className="text-sm font-normal text-zinc-400">/mo</span></span>
              </div>
            ...
            <ul className="space-y-3 text-sm border-t border-zinc-800 pt-6 text-zinc-200">
              <li className="flex items-center gap-3">
                <span className="text-[rgb(215,255,67)] font-bold">✓</span>
                <span><strong>5 Scheduled Pickups</strong> per month</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-[rgb(215,255,67)] font-bold">✓</span>
              ...
              <li className="flex items-center gap-3">
                <span className="text-[rgb(215,255,67)] font-bold">✓</span>
                <span><strong>1.5x Multiplier</strong> on Green Points</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-[rgb(215,255,67)] font-bold">✓</span>
          ...
          >
            {isPro ? "Current Plan" : subscribeMutation.isPending ? "Enrolling..." : "Select Eco Pro"}
          </Button>
        </Card>
      </div>
    </div>
