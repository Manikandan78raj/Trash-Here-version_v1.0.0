...
export class AiController {
  ...
  @ApiOperation({
    summary:
      "Submit uploaded waste image for asynchronous computer vision analysis",
  })
  ...
  @ApiOperation({
    summary: "Get status and telemetry of an asynchronous AI job",
  })
  ...
  @ApiOperation({
    summary:
      "Retrieve completed AI prediction with bounding boxes and carbon savings",
  })
  ...
  @ApiOperation({
    summary: "Get health and latency metrics across all vision models",
  })
