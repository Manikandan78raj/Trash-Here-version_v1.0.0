...
export class RecyclerController {
  ...
  @Get('intake/loads')
  async getFacilityLoads(@Request() req: any, @Query('status') status?: LoadStatus) {
  ...
  async getQueueItems(@Request() req: any, @Query('status') status?: ProcessingStatus) {
  ...
  @Post('esg/generate')
  async generateEsgReport(@Request() req: any, @Body() dto: GenerateEsgReportDto) {
